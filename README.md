...
## Project
In this project,I learned how to implement synchrounous counter and comparator in the reality.For example, counter up and down to control the elevator.By using comparator,elevator can be stop at the floor user seleted. Password implemented by using Hexadecimal input and decoder to make sure security is protected.   
[Report](https://github.com/limlijing/SECR1013_DL/blob/main/GROUP%202%20REPORT%20(1).pdf)
